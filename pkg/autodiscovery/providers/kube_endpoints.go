...
const (
	...
	kubeEndpointResolveAuto      = "auto"
	kubeEndpointResolveIP        = "ip"
	kubePodKind                  = "Pod"
...
func generateConfigs(tpl integration.Config, resolveMode string, kep *v1.Endpoints) []integration.Config {
	if kep == nil {
